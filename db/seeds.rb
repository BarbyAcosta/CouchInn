...
if User.where(email: 'otro@live.com.ar').empty?
	u2=User.create(email: 'otro@live.com.ar', name: 'Otra', lastname: 'Persona', genero: 'Hombre', dni: '12365414', provincia: 'Buenos Aires', localidad: 'La Plata', password: 'contraseña',  password_confirmation: 'contraseña', premium: 'false', admin: 'false')
end
if User.where(email: 'gina@live.com.ar').empty?
	u3=User.create(email: 'gina@live.com.ar', name: 'Gina', lastname: 'Galvez Huerta', genero: 'Mujer', dni: '34569874', provincia: 'Buenos Aires', localidad: 'La Plata',password: 'contraseña',  password_confirmation: 'contraseña',premium: 'false', admin: 'true')
end
...
puts "cargo categoria de reservas"
 ...
 if Couch.where(name:'Casa').empty?
...
if Couch.where(name:'Sillon').empty?
...
if Couch.where(name:'Departamento').empty? 
...
if Couch.where(name:'Habitacion').empty?
...
if Couch.where(name:'Piso').empty?
...
Reserve.where(name:'Casa',fechaini:'12/12/2016',fechafin:'20/12/2016', confirmada: 'false',couch: c1).first_or_create
Reserve.where(name:'Sillon',fechaini:'1/12/2016',fechafin:'5/12/2016',  confirmada: 'false',couch: c2).first_or_create
Reserve.where(name:'Departamento',fechaini:'7/2/2016',fechafin:'9/2/2016' , confirmada: 'false',couch: c3).first_or_create
