...
Couch.create(name:'Casa',description:"Hermosa casa con ubicacion excelente",imageurl:"https://dl.dropboxusercontent.com/u/34731102/casa.jpg" ,tipocouch_id:1, capacidad:5 ,localidad: "La Plata" , user: u1 )
Couch.create(name:'Sillon',description:"Confortable sillon ",imageurl:"https://dl.dropboxusercontent.com/u/34731102/sillon.jpg", tipocouch_id:2, capacidad:3 ,localidad: "Neuquen", user: u1 )
Couch.create(name:'Departamento',description:"Hermoso departamento, excelente vista",imageurl:"https://dl.dropboxusercontent.com/u/34731102/Departamento%20barato.jpg", tipocouch_id:3, capacidad:1 ,localidad: "Misiones" , user: u1 )
Couch.create(name:'Habitacion',description:"Espaciosa habitacion",imageurl:"https://dl.dropboxusercontent.com/u/34731102/habitacion.jpg", tipocouch_id:4 , capacidad:2 ,localidad: "La Rioja" ,user: u1 )
